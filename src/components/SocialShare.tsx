...
export function SocialShare({ 
  ...
  description = 'Free YouTube tools collection. Download thumbnails, extract metadata, and more!'
}: SocialShareProps) {
  ...
  const socialPlatforms = [
    ...
    },
    {
      ...
      url: `https://www.reddit.com/submit?url=${shareData.url}&title=${shareData.title}`,
        ...
        {isOpen && (
          <div className="absolute top-full mt-2 right-0 bg-white rounded-xl shadow-2xl border border-gray-200 p-4 z-50 min-w-[280px]">
            <div className="flex items-center justify-between mb-3">
              <h3 className="font-semibold text-gray-900">Share this tool</h3>
              <button
            ...
            <ClientOnly>
              {typeof navigator !== 'undefined' && navigator.share && (
                <button
                  ...
                  className="w-full flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-gray-50 transition-colors mb-2"
                >
                  ...
                  <span className="text-gray-700">Native Share</span>
                </button>
              )}
            </ClientOnly>
            ...
            <div className="grid grid-cols-2 gap-2">
              {socialPlatforms.map((platform) => (
                <button
                  ...
                  className={`flex items-center space-x-2 px-3 py-2 rounded-lg border border-gray-200 transition-all duration-200 ${platform.color}`}
                >
